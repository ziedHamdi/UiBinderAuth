...
public interface FieldWriter {
   ...
   * </dl>
   *
   * {@see fr.onevu.gwt.uibinder.rebind.FieldWriter#writeFieldGetter}.
   */
   ...
   */
	...
	void writeFieldDefinition(IndentedWriter writer, TypeOracle typeOracle, OwnerClass ownerClass, FieldWriter field, DesignTimeUtils designTime, int counter,
			boolean useLazyWidgetBuilders) throws UnableToCompleteException;

	// replaced by a more context aare version: we need to know the class of the
	// field when we create it
