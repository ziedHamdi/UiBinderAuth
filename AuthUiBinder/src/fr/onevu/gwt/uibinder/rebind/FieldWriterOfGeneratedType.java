...
public class FieldWriterOfGeneratedType extends AbstractFieldWriter {
	...
	protected final JClassType assignableType;

	public FieldWriterOfGeneratedType(FieldManager manager, JClassType assignableType, String typePackage, String typeName, String name, MortalLogger logger) {
