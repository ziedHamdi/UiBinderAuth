...
import fr.onevu.gwt.uibinder.elementparsers.SimpleInterpeter;
...
import fr.onevu.gwt.uibinder.rebind.model.ImplicitDataResource;
import fr.onevu.gwt.uibinder.rebind.model.ImplicitImageResource;
...
public class UiBinderParser {
  ...
  public FieldWriter parse(XMLElement elem) throws UnableToCompleteException {
    ...
    FieldWriter fieldToReturn = writer.parseElementToField(uiRoot);
