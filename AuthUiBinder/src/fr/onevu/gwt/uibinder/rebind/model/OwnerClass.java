...
/**
 * Model class with all attributes of the owner class. This includes factories,
 * fields and handlers.
 */
public class OwnerClass {
	 ...
	 * @param logger
	 */
	public OwnerClass(JClassType ownerType, MortalLogger logger, UiBinderContext context) throws UnableToCompleteException {
		this.logger = logger;
	...
	/**
	 * Gets a field with the given name. It's important to notice that a field may
	 * not exist on the owner class even if it has a name in the XML and even has
	 * handlers attached to it - such a field will only exist in the generated
	 * binder class.
	 * 
	 * @param name
	...
	/**
	 * Gets the field with the given type. Note that multiple fields can have the
	 * same type, so it only makes sense to call this to retrieve resource fields,
	 * such as messages and image bundles, for which only one instance is
	 * expected.
	 * 
	 * @param type
	 *          the type of the field
	 * @return the field descriptor
	 * @deprecated This will die with
	 *             {@link fr.onevu.gwt.uibinder.attributeparsers.BundleAttributeParser}
	 */
	@Deprecated
