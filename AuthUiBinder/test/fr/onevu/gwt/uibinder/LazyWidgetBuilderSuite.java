...
import fr.onevu.gwt.uibinder.test.client.CellPanelParserIntegrationTest;
import fr.onevu.gwt.uibinder.test.client.IsRenderableIntegrationTest;
import fr.onevu.gwt.uibinder.test.client.LazyPanelParserIntegrationTest;
import fr.onevu.gwt.uibinder.test.client.LazyWidgetBuilderSafeUriIntegrationTest;
import fr.onevu.gwt.uibinder.test.client.SafeHtmlAsComponentsTest;
import fr.onevu.gwt.uibinder.test.client.UiBinderParserUiWithAttributesTest;
import fr.onevu.gwt.uibinder.test.client.UiProvidedNullTest;
import fr.onevu.gwt.uibinder.test.client.UiRendererEventsTest;
import fr.onevu.gwt.uibinder.test.client.UiRendererTest;
