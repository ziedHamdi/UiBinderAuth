 ...
 * the License.
 */
package fr.onevu.gwt.uibinder.elementparsers;
...
import fr.onevu.gwt.uibinder.rebind.DesignTimeUtilsStub;
import fr.onevu.gwt.uibinder.rebind.FieldManager;
import fr.onevu.gwt.uibinder.rebind.FieldWriter;
import fr.onevu.gwt.uibinder.rebind.MockMortalLogger;
import fr.onevu.gwt.uibinder.rebind.W3cDomHelper;
import fr.onevu.gwt.uibinder.rebind.XMLElement;
import fr.onevu.gwt.uibinder.rebind.XMLElementProvider;
import fr.onevu.gwt.uibinder.rebind.XMLElementProviderImpl;
  ...
  static final MockJavaResource BINDER_OWNER_JAVA = new MockJavaResource(
    ...
    public CharSequence getContent() {
      ...
      code.append("  public interface BaseClass extends "
          + "fr.onevu.gwt.uibinder.client.UiBinder<Widget, BaseClass> {}\n");
      code.append("}\n");
      return code;
    }
  };
