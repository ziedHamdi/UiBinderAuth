 ...
 * the License.
 */
package fr.onevu.gwt.uibinder.rebind.model;
...
import fr.onevu.gwt.uibinder.rebind.MortalLogger;
import fr.onevu.gwt.uibinder.rebind.UiBinderContext;
import fr.onevu.gwt.uibinder.test.UiJavaResources;
...
public class OwnerClassTest extends TestCase {
	...
	private Set<Resource> getJavaResources() {
		MockJavaResource[] javaFiles = { new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.EmptyOwnerClass") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
				code.append("public class EmptyOwnerClass {\n");
				code.append("}\n");
				return code;
			}
		}, new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.BadUiFactoryClass") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
				code.append("import fr.onevu.gwt.uibinder.client.UiFactory;\n");
				code.append("public class BadUiFactoryClass {\n");
				code.append("  @UiFactory int thisShouldntWork() { return 0; }\n");
				code.append("}\n");
				return code;
			}
		}, new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.UiFieldsClass") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
				...
				code.append("import fr.onevu.gwt.uibinder.client.UiField;\n");
		...
		}, new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.UiHandlersClass") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
				...
				code.append("import fr.onevu.gwt.uibinder.client.UiHandler;\n");
		...
		}, new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.BadUiFieldsClass") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
		...
		}, new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.UiFactoryClass") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
		...
		}, new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.Abstract") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
		...
		}, new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.WildcardWidgetFactory") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
		...
		}, new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.ParamterizedWidgetFactory") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
		...
		}, new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.TooManyGenerics") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
		...
		}, new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.DuplicateUiFactoryClass") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
		...
		}, new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.ParentUiBinderClass") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
		...
		}, new MockJavaResource("fr.onevu.gwt.uibinder.rebind.model.ChildUiBinderClass") {
			@Override
			public CharSequence getContent() {
				StringBuffer code = new StringBuffer();
				code.append("package fr.onevu.gwt.uibinder.rebind.model;\n");
	...
	public void testOwnerClass_empty() throws UnableToCompleteException {
		JClassType ownerType = types.findType("fr.onevu.gwt.uibinder.rebind.model.EmptyOwnerClass");
	...
	public void testOwnerClass_uiFactory() throws UnableToCompleteException {
		JClassType ownerType = types.findType("fr.onevu.gwt.uibinder.rebind.model.UiFactoryClass");
		OwnerClass ownerClass = new OwnerClass(ownerType, MortalLogger.NULL, uiBinderCtx);
	...
	public void testParameterizedWidgets() throws UnableToCompleteException {
		JClassType ownerType = types.findType("fr.onevu.gwt.uibinder.rebind.model.ParamterizedWidgetFactory");
		JClassType abstractType = types.findType("fr.onevu.gwt.uibinder.rebind.model.Abstract");
		OwnerClass ownerClass = new OwnerClass(ownerType, MortalLogger.NULL, uiBinderCtx);
	...
	public void testWildcardWidgets() throws UnableToCompleteException {
		JClassType ownerType = types.findType("fr.onevu.gwt.uibinder.rebind.model.WildcardWidgetFactory");
		JClassType abstractType = types.findType("fr.onevu.gwt.uibinder.rebind.model.Abstract");
		OwnerClass ownerClass = new OwnerClass(ownerType, MortalLogger.NULL, uiBinderCtx);
	...
	public void testHowSuckyWeReallyAreWithGenerics() {
		JClassType ownerType = types.findType("fr.onevu.gwt.uibinder.rebind.model.TooManyGenerics");
	...
	public void testOwnerClass_uiFactoryBadType() {
		JClassType ownerType = types.findType("fr.onevu.gwt.uibinder.rebind.model.BadUiFactoryClass");
		try {
			new OwnerClass(ownerType, MortalLogger.NULL, uiBinderCtx);
	...
	public void testOwnerClass_uiFactoryDuplicateType() {
		JClassType ownerType = types.findType("fr.onevu.gwt.uibinder.rebind.model.DuplicateUiFactoryClass");
		try {
			new OwnerClass(ownerType, MortalLogger.NULL, uiBinderCtx);
			fail("Expected exception not thrown.");
		} catch (UnableToCompleteException utce) {
	...
	public void testOwnerClass_uiFields() throws UnableToCompleteException {
		JClassType ownerType = types.findType("fr.onevu.gwt.uibinder.rebind.model.UiFieldsClass");
		OwnerClass ownerClass = new OwnerClass(ownerType, MortalLogger.NULL, uiBinderCtx);
	...
	public void testOwnerClass_uiFieldsBadType() {
		JClassType ownerType = types.findType("fr.onevu.gwt.uibinder.rebind.model.BadUiFieldsClass");
		try {
			new OwnerClass(ownerType, MortalLogger.NULL, uiBinderCtx);
			fail("Expected exception not thrown.");
		} catch (UnableToCompleteException utce) {
	...
	public void testOwnerClass_uiHandlers() throws UnableToCompleteException {
		JClassType ownerType = types.findType("fr.onevu.gwt.uibinder.rebind.model.UiHandlersClass");
		OwnerClass ownerClass = new OwnerClass(ownerType, MortalLogger.NULL, uiBinderCtx);
	...
	public void testOwnerClass_withParent() throws UnableToCompleteException {
		JClassType ownerType = types.findType("fr.onevu.gwt.uibinder.rebind.model.ChildUiBinderClass");
		OwnerClass ownerClass = new OwnerClass(ownerType, MortalLogger.NULL, uiBinderCtx);
