...
/**
 * Sample use of a {@code UiBinder} with no dependency on com.google.gwt.user.
 */
public class DomBasedUi {
	...
	Element root;
	@UiField
	TableColElement narrowColumn;
	@UiField
	TableRowElement tr;
	@UiField
	TableCellElement th1;
	@UiField
	TableCellElement th2;
	@UiField
	TableSectionElement tbody;
	@UiField
	TableCellElement th4;
