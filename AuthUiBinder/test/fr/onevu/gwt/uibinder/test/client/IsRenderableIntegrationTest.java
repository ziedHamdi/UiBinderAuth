...
public class IsRenderableIntegrationTest extends GWTTestCase {
	...
	public void testDeep() {
		 ...
		 * 
		 * Hmm. What keeps the object that fills in the fields at attach time from
		 * being gc'd? And are we sure it's not leaking?
		 * 
	...
	public void testNestedRenderableComposite() {
		...
		try {
			...
			assertEquals("[dom built]Renderable", meta.getWidget().getElement().getInnerText());
		} finally {
	...
	public void testRenderableComposite() {
		...
		try {
			...
			assertEquals("[dom built]Renderable", renderableComposite.getWidget().getElement().getInnerText());
		} finally {
	...
	public void testShallow() {
		...
		try {
			...
			assertEquals("[dom built]" + shallow.widget.getText(), shallow.widget.getElement().getInnerText());
		} finally {
