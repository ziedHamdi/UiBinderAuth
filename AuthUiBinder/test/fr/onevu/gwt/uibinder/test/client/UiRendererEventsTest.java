...
import fr.onevu.gwt.uibinder.test.client.UiRendererUi.Bar;
import fr.onevu.gwt.uibinder.test.client.UiRendererUi.Foo;
...
public class UiRendererEventsTest extends GWTTestCase {
	 ...
	 * {@link UiRendererUi.HtmlRenderer#onBrowserEvent(MockBarReceiver, NativeEvent, Element, UiRendererUi.Bar, int)}
	 * .
	 */
	...
	public class MockBaseReceiver extends AbstractCell<Integer> {
		...
		@Override
		public void render(com.google.gwt.cell.client.Cell.Context context, Integer value, SafeHtmlBuilder sb) {
			UiRendererUi.getInheritedRenderer().render(sb, new Foo(value.toString()), new Foo(value.toString()));
		}
	 ...
	 * {@link UiRendererUi.InheritedRenderer#onBrowserEvent(MockBazReceiver, NativeEvent, Element, boolean)}
	 * .
	 */
	 ...
	 * {@link UiRendererUi.HtmlRenderer#onBrowserEvent(MockFooReceiver, NativeEvent, Element, UiRendererUi.Foo, String)}
	 * .
	 */
	...
	public String getModuleName() {
		return "fr.onevu.gwt.uibinder.test.LazyWidgetBuilderSuite";
	}
