...
public class WidgetBasedUi extends Composite {
	...
	@UiField
	HorizontalPanel myHorizontalPanel;
	@UiField
	...
	@UiField
	Widget myProvidedDisclosurePanelItem;
	@UiField
	Tree myTree;
	@UiField
	TreeItem myTreeItemA;
	@UiField
	Widget myTreeWidgetB;
	@UiField
	TreeItem myTreeItemC;
	@UiField
	TreeItem myTreeItemCA;
	@UiField
	Widget myTreeWidgetCB;
	@UiField
	...
	@UiField(provided = true)
	final AnnotatedStrictLabel providedAnnotatedStrictLabel = new AnnotatedStrictLabel("likewise");
	@UiField
	...
	@UiField(provided = true)
	final StrictLabel providedStrictLabel = new StrictLabel("provided");
	@UiField
	FooLabel theFoo;
	@UiField
	...
	@UiField
	ParagraphElement bracedParagraph;
	@UiField
	EnumeratedLabel enumLabel;
	@UiField
	PushButton pushButton;
	@UiField
	Label lblDebugId;
	@UiField
	HasHTML mixedMessageWidget;
	@UiField
	SpanElement mixedMessageSpan;
	@UiField
	FooLabel primitiveIntoObject;
	@UiField
	FooLabel objectIntoPrimitive;
	@UiField
	FooLabel allObject;
	@UiField
	FooLabel allPrimitive;
	@UiField
	FooLabel mismatchPrimitiveIntoObject;
	@UiField
	FooLabel allMismatchPrimitive;
	@UiField
	FooLabel primitiveBooleanIntoObject;
	@UiField
	FooLabel objectBooleanIntoPrimitive;
	@UiField
	FooLabel allObjectBoolean;
	@UiField
	FooLabel allPrimitiveBoolean;
	@UiField
	ToggleButton toggle;
	@UiField
	HTML styleLess;
	...
	@UiField
	Widget myAbsolutePanelItemA;
	@UiField
	Widget myAbsolutePanelItemB;
	@UiField
	Widget myAbsolutePanelItemC;
	@UiField
	NamedFrame myNamedFrame;
	@UiField
	...
	@UiField
	NumberLabel<Float> myNumberLabel;
	@UiField
	NumberLabel<Float> myNumberLabel2;
	@UiField(provided = true)
	@SuppressWarnings("rawtypes")
	Renderer doubleRenderer = DoubleRenderer.instance();
	@UiField
	ValueLabel<Double> myValueLabel;
	@UiField
	IntegerBox myIntegerBox;
	@UiField
	DoubleBox myDoubleBox;
	@SuppressWarnings("rawtypes")
	@UiField
	ValueChangeWidget<List> myValueChangeWidget;
	@SuppressWarnings("rawtypes")
	@UiField
	ValueChangeWidget myValueChangeWidget_raw;
	@SuppressWarnings("rawtypes")
	@UiField
	ExtendsValueChangeWidget<List> myValueChangeWidget_extends;
	@UiField
	ImageElement myImage;
	@UiField
	HTML htmlWithComputedSafeHtml;
	@UiField
	HTML htmlWithComputedText;
	@UiField
	Label labelWithComputedText;
	@UiField
	FlowPanel flowPanelWithTag;
